...
PluginSelector::PluginSelector(QWidget *parent) : QDialog(parent), ui(new Ui::PluginSelector)
{
    ui->setupUi(this);
...
void PluginSelector::connectUi()
{
    ...
    connect(ui->pluginList, &QListWidget::itemSelectionChanged, this,
            [this]() { ui->okButton->setEnabled(!ui->pluginList->selectedItems().isEmpty()); });
